                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="row register-form">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <textarea name="description" id="" cols="20" rows="5" class="form-control" value="{{$item->description}}"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="{{$item->category}}" name="category" />
                                    </div>
